...
nHistoryID: nHistoryID,
        ...
        window.FormIt.Layers.GetObjectsLayerList = function(groupInstacePathArray) {
            args = {
...
window.FormIt.IPC = window.FormIt.IPC || {};

        window.FormIt.IPC.CreateConnection = function(config) {
            args = {
...
config: config
        ...
        window.FormIt.IPC.Terminate = function(h) {
            args = {
...
h: h
        ...
        window.FormIt.IPC.SendMessage = function(h,message) {
            args = {
...
h: h,
        ...
        window.FormIt.IPC.RunJSONCommand = function(message) {
            args = {
