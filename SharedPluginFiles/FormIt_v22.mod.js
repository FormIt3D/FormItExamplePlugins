...
ptX: ptX,
        ...
        WSM.Utils.GroupInstancePathArray = function(objectIDs,History,groupInstancePath) {
            const args = {
...
ObjectIDs: ObjectIDs
        ...
        WSM.Utils.ObjectHistoryIDArray = function(objectIDs,History) {
            const args = {
...
historyId: historyId,
        ...
        FormIt.Dynamo.GetInputNode = function(historyId,guid) {
            const args = {
...
historyId: historyId
        ...
        FormIt.Dynamo.StringToLength = function(lengthStr) {
            const args = {
...
unitType: unitType
        ...
        FormIt.Model.ImperialLengthToCurrentUnitLength = function(length) {
            const args = {
...
FormIt.LumionLiveSync = {};

        FormIt.LumionLiveSync.Start = function() {
            const args = {
        ...
        FormIt.LumionLiveSync.End = function() {
            const args = {
        ...
        FormIt.LumionLiveSync.SyncLumionCamera = function() {
            const args = {
        ...
        FormIt.LumionLiveSync.FollowLumionCamera = function(bFollowCamera) {
            const args = {
...
bEnable: bEnable,
        ...
        FormIt.SunAndLocation.GetLightDirectionFromLocationData = function(sunLocationData) {
            const args = {
...
token: token,
        ...
        FormIt.Testing.Sleep = function(time) {
            const args = {
